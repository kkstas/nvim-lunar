if vim.g.neovide then
    ...
    -- vim.o.guifont = "JetBrainsMono_Nerd_Font_Propo:h15:i" -- ten lżejszy
    -- vim.o.guifont = "JetBrainsMono_Nerd_Font_Propo:h14" -- ten lżejszy
    -- vim.o.guifont = "M+CodeLatx Nerd Font Mono:h14" -- ten lżejszy
    vim.o.guifont = "M+CodeLatx Nerd Font Propo:h14" -- ten lżejszy
    ...
    -- vim.g.neovide_background_color = "#1c1f25" .. alpha()
